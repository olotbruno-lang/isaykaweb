...
export default function Commande() {
  ...
  const inputCls = "w-full bg-[rgba(255,255,255,0.35)] backdrop-blur-md border border-[rgba(200,81,42,0.25)] shadow-[0_2px_6px_rgba(0,0,0,0.08),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.5),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.05),inset_0_0_6px_6px_rgba(255,255,255,0.1),0_0_20px_rgba(200,81,42,0.15)] text-[#1a1815] rounded-xl px-4 py-3 text-[0.88rem] font-light outline-none focus:border-[rgba(200,81,42,0.45)] focus:shadow-[0_2px_6px_rgba(0,0,0,0.08),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.5),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.05),inset_0_0_6px_6px_rgba(255,255,255,0.1),0_0_0_3px_rgba(200,81,42,0.10),0_0_24px_rgba(200,81,42,0.28),0_0_48px_rgba(200,81,42,0.14)] transition-all duration-300 placeholder:text-[#8b7863]"
